...
module.exports ={
  createGameType: function(user_id, game_id){
   ...
   readTeamGameID: function(team_id){
     return knex.raw(`SELECT * from team_games WHERE team_id=${team_id}`)
   },
 ...
 readTeamId: function(team){
  ...
  addTeamStats: function(team_game_id, team_id){
    return knex.raw(`INSERT into team_game_stats (team_id, team_game_id, "gamesPlayed", "teamRating", "teamConstant") values (${team_id}, ${team_game_id}, 0, 100, 40)`)
  },
