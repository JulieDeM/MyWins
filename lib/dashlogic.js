...
module.exports ={
  createGameType: function(user_id, game_id){
    // Julie's code here
    //one posibility is to change the name of the input submit button to be the name that will pull in the object of the user_id which will then be submitted to the database
  ...
  createGameTypeTeam: function(user_id, teammate_id, game_id){
      // return knex.raw(`insert into teams (game_id, user_id) values (${game_id}, ${user_id})`);
  },
