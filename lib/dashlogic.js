...
module.exports ={
  createGameType: function(user_id, game_id){
    ...
    // return knex.raw(`SELECT id from games as games_id`){
    //   knex.raw(`SELECT id from users as user_id`)
    // }


    return knex.raw(`insert into user_games (game_id, user_id) values (${game_id}, ${user_id})`);
